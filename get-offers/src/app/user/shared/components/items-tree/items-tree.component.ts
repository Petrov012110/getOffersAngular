...
import { ChecklistDatabase } from '../../services/item-tree.service';
...
@Component({
    ...
    styleUrls: ['./styles/items-tree.component.scss'],
...
export class ItemsTreeComponent {
    ...
    getChildren = (node: TodoItemNode): TodoItemNode[] | any => node.children;
